    ...
    return (
        <nav className="bg-gray-800 flex justify-between items-center h-20 p-4">
            <a href="#" className="flex items-center">
                ...
                <p className="text-yellow-50 ml-4 font-semibold text-2xl mr-auto">LexIris</p>
            </a>
            <ul className="flex gap-6 list-none text-gray-200">
                ...
                <a href="/login"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
